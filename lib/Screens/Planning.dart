                ...
                builder: (context, snapshot) {
                  return !snapshot.hasData
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            DocumentSnapshot data = snapshot.data.docs[index];
                            return DayItem(Secteurs: [data['Lundi']]);
                          },
                        );
                },
              ),
                ...
                builder: (context, snapshot) {
                  return !snapshot.hasData
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            DocumentSnapshot data = snapshot.data.docs[index];
                            return DayItem(Secteurs: [data['Mardi']]);
                          },
                        );
                },
              ),
                ...
                builder: (context, snapshot) {
                  return !snapshot.hasData
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            DocumentSnapshot data = snapshot.data.docs[index];
                            return DayItem(Secteurs: [data['Mercredi']]);
                          },
                        );
                },
              ),
                ...
                builder: (context, snapshot) {
                  return !snapshot.hasData
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            DocumentSnapshot data = snapshot.data.docs[index];
                            return DayItem(Secteurs: [data['Jeudi']]);
                          },
                        );
                },
              ),
                ...
                builder: (context, snapshot) {
                  return !snapshot.hasData
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            DocumentSnapshot data = snapshot.data.docs[index];
                            return DayItem(Secteurs: [data['Vendredi']]);
                          },
                        );
                },
              ),
                ...
                builder: (context, snapshot) {
                  return !snapshot.hasData
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            DocumentSnapshot data = snapshot.data.docs[index];
                            return DayItem(Secteurs: [data['Samedi']]);
                          },
                        );
                },
              ),
